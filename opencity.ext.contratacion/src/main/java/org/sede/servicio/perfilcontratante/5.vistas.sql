CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_LICITADORES_SERVICIO" ("ID_EMPRESA", "NOMBRE", "ORGANO", "ANYO", "TOTALSINIVA", "TOTALCONIVA", "TOTALLICITACIONES") AS
...
where CONT.ID_PORTAL=1 and O.GANADOR='S' and CONT.ID_TIPOCONTRATO!=6
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADOR_TIPO_SERGES" ("SERVICIO_GESTOR", "TOTALCONTRATOS", "ID_TIPOCONTRATO", "ANYO", "TOTALSINIVA", "TOTALCONIVA") AS
...
where CONT.ID_PORTAL=1 and OFER.GANADOR='S' and CONT.ID_TIPOCONTRATO!=6
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADOR_TIPO" ("ID_PORTAL", "TOTALCONTRATOS", "ID_TIPOCONTRATO", "ANYO", "TOTALSINIVA", "TOTALCONIVA") AS
...
from PERFIL_CONTRATO CONT
  ...
  inner join PERFIL_TIPOCONTRATO TIPO
    on TIPO.ID_TIPOCONTRATO=CONT.ID_TIPOCONTRATO
where OFER.GANADOR='S' and CONT.ID_TIPOCONTRATO!=6
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADOR_PROC_SERVGES" ("SERVICIO_GESTOR", "TOTALCONTRATOS", "ID_PROCEDIMIENTO", "ANYO", "TOTALSINIVA", "TOTALCONIVA") AS
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADOR_LICITADOR" ("ID_EMPRESA", "NOMBRE", "TOTALSINIVA", "TOTALCONIVA", "ANYO", "TOTALLICITACIONES", "ID_PORTAL") AS
...
from PERFILCONTRATANTE.PERFIL_CONTRATO CONT
  ...
  inner join PERFILCONTRATANTE.PERFIL_EMPRESA E
    on E.ID_EMPRESA=O.ID_EMPRESA
where CONT.ID_TIPOCONTRATO!=6
group by O.ID_EMPRESA,E.NOMBRE, TO_CHAR(CONT.GCZ_FECHACONTRATO,'yyyy'),CONT.ID_PORTAL
ORDER BY ANYO asc,TOTALLICITACIONES desc;


CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADOR_AHORRO_SERGES" ("ID_PORTAL", "SERVICIO_GESTOR", "ANYO", "ID_CONTRATO", "IMPORTEOFERTA", "IMPORTECONTRATO", "AHORRO", "NOMBRE", "ID_PROCEDIMIENTO", "ID_TIPOCONTRATO") AS
select  CONT1.ID_PORTAL,CONT1.SERVICIO_GESTOR,TO_CHAR(CONT1.GCZ_FECHACONTRATO,'yyyy') as ANYO,CONT1.ID_CONTRATO ,SUM(O.IMPORTE_SINIVA) as IMPORTEOFERTA,CONT1.IMPORTE_SINIVA as IMPORTECONTRATO,
...
where CONT1.GCZ_PUBLICADO ='S' and CONT1.ID_TIPOCONTRATO!=6 and  O.GANADOR='S' and  (O.CANON='NO' or O.CANON='N' or O.CANON='No') and CONT1.IMPORTE_SINIVA is not null and O.AHORRO_VISIBLE='S'
group by O.ID_CONTRATO,CONT1.ID_PORTAL,CONT1.ID_CONTRATO,CONT1.IMPORTE_SINIVA,TO_CHAR(CONT1.GCZ_FECHACONTRATO,'yyyy'),CONT1.NOMBRE,CONT1.ID_PROCEDIMIENTO,CONT1.ID_TIPOCONTRATO,CONT1.SERVICIO_GESTOR
order by ANYO desc ,AHORRO desc;

CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADOR_AHORRO" ("ID_PORTAL", "ANYO", "ID_CONTRATO", "IMPORTEOFERTA", "IMPORTECONTRATO", "AHORRO", "NOMBRE", "ID_PROCEDIMIENTO", "ID_TIPOCONTRATO") AS
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADORES_TIPO" ("ID_PORTAL", "CONT_MENOR", "ANYO", "TOTAL", "TOTALSINIVA", "TOTALCONIVA") AS
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_INDICADORES_SERVICIO" ("ID_PORTAL", "SERVICIO_GESTOR", "TOTALCONTRATOS", "TOTALCONIVA", "TOTALSINIVA", "ANYO") AS
...
where O.GANADOR='S' and CONT.ID_PORTAL=1 and CONT.ID_TIPOCONTRATO!=6
group by CONT.ID_PORTAL,CONT.SERVICIO_GESTOR,TO_CHAR(CONT.GCZ_FECHACONTRATO,'yyyy');

CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_DATOS_PROCEDIMIENTO" ("ID_PORTAL", "TOTALCONTRATOS", "ID_PROCEDIMIENTO", "ANYO", "TOTALSINIVA", "TOTALCONIVA") AS
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_CONTRATOS_SERVICIO_ANYO" ("SERVICIO_GESTOR", "ANYO", "TOTAL", "TOTALSINIVA", "TOTALCONIVA") AS
...
CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_CONTRATOS_ORGANOC" ("ORGANO_CONTRATACION", "ANYO", "TOTAL", "TOTALSINIVA", "TOTALCONIVA") AS
...
REATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTA_CONTRATOS_ENTIDAD_ANYO" ("ID_PORTAL", "ANYO", "TOTAL", "TOTALSINIVA", "TOTALCONIVA") AS
select CONT.ID_PORTAL,TO_CHAR(CONT.GCZ_FECHACONTRATO, 'yyyy') as ANYO,COUNT(*) as TOTAL,SUM(CONT.IMPORTE_SINIVA) as TOTALSINIVA,SUM(CONT.IMPORTE_CONIVA) as TOTALCONIVA
from PERFIL_OFERTA ADJ
right join PERFIL_CONTRATO CONT
  on CONT.ID_CONTRATO = ADJ.ID_CONTRATO
where CONT.ID_TIPOCONTRATO!=6
group by TO_CHAR(CONT.GCZ_FECHACONTRATO, 'yyyy'),CONT.ID_PORTAL
order by ANYO;


CREATE OR REPLACE FORCE VIEW "PERFILCONTRATANTE"."VISTAS_PERFIL_LICITADORES" ("ID_EMPRESA", "NOMBRE", "TOTALSINIVA", "TOTALCONIVA", "ANYO", "TOTALLICITACIONES") AS
