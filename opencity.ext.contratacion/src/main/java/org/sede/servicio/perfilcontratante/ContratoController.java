...
public class ContratoController {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDoc(@PathVariable BigDecimal id) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleLicitador(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiListadoLicitador(@Fiql SearchFiql search) throws SearchParseException {
    ...
    @RequestMapping(method = RequestMethod.GET, produces = {MimeTypes.JSON, MimeTypes.XML, MimeTypes.CSV, MimeTypes.JSONLD, MimeTypes.RDF, MimeTypes.TURTLE, MimeTypes.RDF_N3,MimeTypes.RSS})
    public @ResponseBody
    ResponseEntity<?> apiHome(@Fiql SearchFiql search, @RequestParam(name = "cpv", required = false) BigDecimal cpv, @RequestParam(name = "licitador", required = false) BigDecimal idEmpresa) throws SearchParseException, ParseException {
    ...
    @OpenData
    @ResponseClass(value = Contrato.class, entity = SearchResult.class)
    @RequestMapping(value = "/contrato", method = RequestMethod.GET, produces = {MimeTypes.JSON, MimeTypes.XML, MimeTypes.CSV, MimeTypes.JSONLD, MimeTypes.RDF, MimeTypes.TURTLE, MimeTypes.RDF_N3,MimeTypes.RSS})
    public @ResponseBody
    ResponseEntity<?> apiListadosContratos(@Fiql SearchFiql search, @RequestParam(name = "licitador", required = false) BigDecimal idEmpresa) throws SearchParseException, ParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoresProceDimiento(@Fiql SearchFiql search, @RequestParam(name = "idPortal", defaultValue = "1") BigDecimal idPortal, @RequestParam(name = "anyo", defaultValue = "") String anyo, @RequestParam(name = "idServicio", required = false) BigDecimal idServicio) throws Exception {
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoresAyuntamiento(@Fiql SearchFiql search, @RequestParam(name = "idPortal", defaultValue = "1") BigDecimal id, @RequestParam(name = "anyo", required = false) String year, @RequestParam(name = "idServicio", defaultValue = "0") BigDecimal idServicio) throws Exception {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalle(@PathVariable BigDecimal id) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleContrato(@PathVariable BigDecimal id) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleServicioGestor(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search, @RequestParam(name = "year", required = false) String year) throws SearchParseException, ParseException {
        String anyo = year;
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoresServicioGestorAnyo(@Fiql SearchFiql search, @RequestParam(name = "anyo", required = true) String year, @RequestParam(name = "idServicio", required = false) BigDecimal idServicio) throws SearchParseException {
        search.setRows(-1);
    ...
    public @ResponseBody
    ResponseEntity<?> apiRelacionadosListar(@Fiql SearchFiql search, @PathVariable BigDecimal id) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiServiciosListar(@Fiql SearchFiql search) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleAnuncio(@PathVariable BigDecimal idAnuncio) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleLicitador(@PathVariable(value = "id") BigDecimal id) {
        Empresa registro = daoEmpresa.find(id);
        if (registro == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new Mensaje(HttpStatus.NOT_FOUND.value(), messageSource.getMessage("generic.notfound", null, LocaleContextHolder.getLocale())));
        } else {
    ...
    public @ResponseBody
    ResponseEntity<?> apiOfertasListar(@Fiql SearchFiql search, @PathVariable(value = "idLicitador") BigDecimal idLicitador, @RequestParam(name = "ganador", required = false) Boolean ganador) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiContratosPorAnyoServicioGestor(@PathVariable BigDecimal id) {
        Search busqueda = new Search(ContratosPorAnyoServicioGestor.class);
        busqueda.addFilterEqual("id.servicio", id);
    ...
    public @ResponseBody
    ResponseEntity<?> apiListadoAdjudicador() {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleAdjudicador(@PathVariable BigDecimal id) {
        Empresa registro = daoEmpresa.find(id);
        if (registro == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new Mensaje(HttpStatus.NOT_FOUND.value(), messageSource.getMessage("generic.notfound", null, LocaleContextHolder.getLocale())));
        } else {
    ...
    public @ResponseBody
    ResponseEntity<?> apiUteEmpresa(@PathVariable BigDecimal id) {
        Empresa registro = daoEmpresa.find(id);
        if (registro == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new Mensaje(HttpStatus.NOT_FOUND.value(), messageSource.getMessage("generic.notfound", null, LocaleContextHolder.getLocale())));
        } else {
    ...
    public @ResponseBody
    ResponseEntity<?> apiUteEmpresaList() {
    ...
    public @ResponseBody
    ResponseEntity<?> apiUteEmpresaList2(@RequestParam(name = "id") BigDecimal id) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiEntidadesListado() {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleEntidades(@Fiql SearchFiql search, @PathVariable BigDecimal id, @RequestParam(name = "year", defaultValue = "") String year, @RequestParam(name = "status.id", defaultValue = "0") BigDecimal estado) throws SearchParseException, ParseException {
        String anyo = year;
        if (StringUtils.isEmpty(year)) {
            anyo = "" + Calendar.getInstance().get(Calendar.YEAR);
        }
    ...
    public @ResponseBody
    ResponseEntity<?> apiListadoCpv(@Fiql SearchFiql search) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiListadoOrgano(@Fiql SearchFiql search) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleOrgano(@PathVariable BigDecimal id) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreServicioGestor(@Fiql SearchFiql search, @RequestParam(name = "idServicio") BigDecimal idServicio, @RequestParam(name = "anyo") String anyo) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreLicitaorServicioGestor(@Fiql SearchFiql search, @RequestParam(name = "idServicio") BigDecimal idServicio, @RequestParam(name = "anyo") String anyo) throws SearchParseException {
        search.setRows(-1);
        if ("".equals(anyo)) {
            anyo = "" + Calendar.getInstance().get(Calendar.YEAR);
        }
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreIndicadorAhorroPortal(@Fiql SearchFiql search, @RequestParam(name = "idPortal") BigDecimal idPortal, @RequestParam(name = "anyo") String anyo) throws SearchParseException {
        search.setRows(-1);
        if ("".equals(anyo)) {
            anyo = "" + Calendar.getInstance().get(Calendar.YEAR);
        }
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreIndicadorAdjudicatario(@Fiql SearchFiql search, @RequestParam(name = "idPortal") BigDecimal idPortal, @RequestParam(name = "anyo") String anyo) throws SearchParseException {
        search.setRows(-1);
        if ("".equals(anyo)) {
            anyo = "" + Calendar.getInstance().get(Calendar.YEAR);
        }
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreIndicadorAhorroServicio(@RequestParam(name = "idPortal") BigDecimal idPortal, @RequestParam(name = "anyo") String anyo, @RequestParam(name = "idServicio") BigDecimal idServicio) throws SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreIndicadorTipo(@RequestParam(name = "idPortal") BigDecimal idPortal, @RequestParam(name = "anyo") String anyo) throws SearchParseException {
        SearchFiql search = new SearchFiql();
    ...
    public @ResponseBody
    ResponseEntity<?> apiIndicadoreIndicadorTipoServicio(@RequestParam(name = "idPortal") BigDecimal idPortal, @RequestParam(name = "idServicio") BigDecimal idServicio, @RequestParam(name = "anyo") String anyo) throws SearchParseException {
        SearchFiql search = new SearchFiql();
        IndicadoresTipo indicador = new IndicadoresTipo();
        search.setRows(-1);
        if ("".equals(anyo)) {
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleOrganismoContratante(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search, @RequestParam(name = "year", required = false) String year) throws SearchParseException, ParseException {
        String anyo = year;
        if (StringUtils.isEmpty(year)) {
            anyo = "" + Calendar.getInstance().get(Calendar.YEAR);
        }
    ...
    public @ResponseBody
    ResponseEntity<?> apiDetalleLicitadorXls(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search) throws ParseException, SearchParseException {
    ...
    public @ResponseBody
    ResponseEntity<?> apiTribunalCuentas(@Fiql SearchFiql search, @RequestParam(name = "cpv", required = false) BigDecimal cpv, @RequestParam(name = "licitador", required = false) BigDecimal idEmpresa) throws ParseException, SearchParseException {
    ...
    @Transactional(Esquema.TMPARTICIPACION)
    public @ResponseBody
    ResponseEntity<?> apidetallelServicioGestorXls(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search, @RequestParam(name = "year", defaultValue = "", required = false) String year) throws ParseException, SearchParseException {
    ...
    @Transactional(Esquema.TMPARTICIPACION)
    public @ResponseBody
    ResponseEntity<?> apidetalleEntidadXls(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search, @RequestParam(name = "year", defaultValue = "", required = false) String year, @RequestParam(name = "status.id", defaultValue = "0") BigDecimal estado) throws ParseException, SearchParseException {
    ...
    @Transactional(Esquema.TMPARTICIPACION)
    public @ResponseBody
    ResponseEntity<?> apidetalleOrganismoXls(@PathVariable(value = "id") BigDecimal id, @Fiql SearchFiql search, @RequestParam(name = "year", defaultValue = "", required = false) String year) throws ParseException, SearchParseException {
